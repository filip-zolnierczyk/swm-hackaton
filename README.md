...
> Real-time AI-powered fact-checking for live audio streams.
...
1. 🎧 Captures live audio stream  
2. 🧠 Transcribes speech in real time  
3. 🔍 Detects factual claims  
4. 🤖 Uses generative AI to verify information  
5. ⚡ Returns instant feedback to the user  
